...
import 'package:moviehut/category/Details/TamilDubbedDetail.dart';
...
class tamildub extends StatelessWidget {
  // This widget is the root of your application.
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'TamilDubbed Collections',
...
class _MyHomePageState extends State<MyHomePage> {
 ...
 static List<String> details =[
    ...
    static List<String> ratings =["2.7","7.5","6.7","7.4","8"];

    
    final List<TamilDubbedDataModel> Fruitdata = List.generate(
        fruitname.length,
            (index)
        => TamilDubbedDataModel('${fruitname[index]}', '${url[index]}','${details[index]}','${ratings[index]}','Rating',''));

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('TamilDubbed Collections'),),
          ...
          itemBuilder: (context,index){
             return Card(
               ...
               (
                 ...
                 onTap: (){
                   Navigator.of(context).push(MaterialPageRoute(builder: (context)=>TamilDubbedDetail(fruitDataModel: Fruitdata[index],)));
                 },
               ),
             );
          }
