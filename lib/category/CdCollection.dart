...
void main() {
  runApp(CdCollections());
}

class CdCollections extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
 ...
 static List<String> details =[
    ...
    final List<CdDataModel> Fruitdata = List.generate(
        fruitname.length,
            (index)
        => CdDataModel('${fruitname[index]}', '${url[index]}','${details[index]}','${ratings[index]}','Rating'));

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('CD Collections'),
          ...
          itemBuilder: (context,index){
             return Card(
               ...
               (
                 ...
                 onTap: (){
                   Navigator.of(context).push(MaterialPageRoute(builder: (context)=>CdDetail(fruitDataModel: Fruitdata[index],)));
                 },
               ),
             );
          }
